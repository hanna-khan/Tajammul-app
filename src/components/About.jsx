...
const About = () => {
  return (
    <>
      <div className="w-[1920px] h-[881px] bg-stone-50">
        ...
        <div className="flex">
          ...
          <div className="right">
            ...
            <div class="absolute mt-[180px] w-[774px] text-xl font-normal leading-[normal] tracking-[0px] text-slate-700">
