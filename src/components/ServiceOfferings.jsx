...
const ServiceOfferings = () => {
  return (
    ...
    <div id="serviceOfferings" className="pb-[12rem] relative w-screen flex justify-center items-center top-[20rem] flex-col font-poppins">
      ...
      <div className="md:flex relative justify-between items-center w-[100%] h-fit bg-[#F8F8F8]">
        ...
        <div className="flex-1 pl-[3rem] relative pt-[8rem] pb-[8rem] md:pt-0 md:pb-0">
          <h1 className="text-4xl mb-2 font-semibold text-[#F16427]">Product</h1>
          <h1 className="text-4xl mb-2 font-semibold text-[#FDCE0C]">Offerings</h1>
