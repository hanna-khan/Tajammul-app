  ...
  return (
    ...
    <div className="relative w-screen flex justify-center items-center top-[20rem] flex-col font-poppins">
      ...
      <div className="md:flex justify-between items-center w-[100%] h-fit bg-[#F8F8F8]">
        ...
        <div className="flex-1 hidden  relative md:flex justify-center items-center bg-gradient-to-br from-blue-800 to-blue-900 h-[25rem] pt-3">
          <img src={RLImage} alt="" className="h-[15rem] mr-[-2rem]" />
        ...
        <div className="flex  relative md:hidden justify-center items-center bg-gradient-to-br from-blue-800 to-blue-900 h-[25rem] pt-3">
          <img src={RLImage} alt="" className="h-[15rem] mr-[-2rem]" />
          <img src={Center2Image} alt="" className="h-[20rem] z-50" />
          <img src={VegImage} alt="" className="h-[15rem] ml-[-1.7rem] z-50" />
          <img className=" absolute left-0 top-[0%] h-[7rem]" src={Decorter2} alt="" srcset="" />
