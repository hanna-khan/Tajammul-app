...
const Feature = () => {
  return (
    <div className="w-screen pb-10 relative top-[19rem] bg-stone-50">
      ...
      <div className="flex xl:justify-between justify-center xl:flex-row flex-col">
        ...
        <div className="flex-1 flex-wrap mx-2 m-auto">
          ...
          As a merchant, you will register your company as well as the products or services it provides. Then, in the booking calendar section, you must include the availability and time slots of those services so that people can book them accordingly. You're ready to profit from selling your goods and services.
          </div>
        </div>
        <div className="xl:block justify-center items-center flex-col flex flex-1 pt-[2rem]">
          <div className="relative left-[14rem] h-[18rem] w-[18rem] mb-[1rem] rounded-2xl bg-white px-5 pb-20 pt-9 text-[20px] font-bold  text-slate-700 drop-shadow-lg">
            <div>
              <div>
                ...
                <p className="text-center mt-2">Add your product or services</p>
              </div>
              <div className="relative rounded-2xl top-[2rem] h-[18rem] w-[18rem]">
              <img
          ...
          <div className="relative top-[-10rem] h-[18rem] w-[18rem] text-[20px] font-bold  text-slate-700">
          <img
                  className="h-[100%] w-[100%] rounded-2xl drop-shadow-lg"
                  src={time}
                  alt=""
